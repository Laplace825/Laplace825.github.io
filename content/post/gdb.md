...
![](../post-images/gdb1.png)此时当我们输入`si`的话，则需要`layout asm`查看汇编，因为这时候步入到主函数返回。我们看见当前的汇编恰好对应`ret`。
![](../post-images/gdb2.png)
