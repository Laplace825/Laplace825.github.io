---
date: '2025-05-11T16:06:46+08:00'
draft: true
title: 'NVIDIA GPU 与 CUDA 结构'
author: Laplace
description: "the NVIDIA GPU and CUDA struct concepts"
...
![NVIDIA GPU Struct](../post-images/gpu/nvidia-gpu-struct.png)
...
![NVIDIA A100 SM](../post-images/gpu/a100-sm.png)
...
![NVIDIA V100 SM Block Struct](../post-images/gpu/v100-sm-block.png)
...
![NVIDIA CUDA Automatic Scalability](../post-images/gpu/cuda-automatic-scalability.png)
...
![NVIDIA CUDA Grid of Thread Blocks](../post-images/gpu/cuda-grid-of-thread-blocks.png)
